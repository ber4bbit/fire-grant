...
class About extends React.Component {
    ...
    btn = document.querySelector('.customButton');
            ...
            <>
                ...
                <div className="about-description wow animate__animated animate__fadeInUp">
                    <div className="container">
                        ...
                        <h6 className="about-text">
                            ...
                            существования мы стремимся усилить положительные и нивелировать отрицательные стороны
                            ИТ-аутсорсинга
                            для наших клиентов.
                        </h6>
                    </div>
                ...
                <div className="about-features wow animate__animated animate__fadeInRight">
                    <div className="container">
                        ...
                        <img alt="Here must be briefcase logo" src={briefcase}
                             className="features-img wow animate__animated animate__fadeInRight"/>
                    </div>
                </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-xl-4 col-lg-5">
                                <div className="contacts">
                                    ...
                                    <div className="contact">
                                        ...
                                        <p className="contacts-text">118547630087, г. Новосибирск, ул.
                                            Немировича-Данченко, д. 122, оф. 4046100215</p>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-8 col-lg-7">
                                <div className="map">
                                    <iframe
                                        src="https://yandex.ru/map-widget/v1/?um=constructor%3A72ba3cc8c0210074cded3266626c63c5a9e925578b3af11a64aa4419868a9144&amp;source=constructor"
                                        width="895" height="720" frameborder="0"></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
