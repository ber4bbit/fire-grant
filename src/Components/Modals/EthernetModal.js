...
const EthernetModal = () => {
    ...
    return (
        <div>
            <div className="modal fade" id="ethernetModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Настройка Интернета и WiFi</h5>
