...
const NoteBookModal = () => {
    ...
    return (
        <div>
            <div className="modal fade" id="notebookModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title" id="exampleModalLabel">Настройка компьютера или ноутбука</h5>
